...
// (Simplified version: log likelihood calculations in generated quantities removed,
//  and effect of fleet size on effort removed)
//
...
parameters {
  ...
  vector<lower=0>[N_loc] sigma_e;      // Catch observation error for each location
  vector<lower=0>[N_loc] sigma_f;              // Observation error for fleet
  // vector<lower=0>[N_loc] sigma_w;             // Observation error for weight
