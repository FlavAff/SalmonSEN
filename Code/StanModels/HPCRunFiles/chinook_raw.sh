...
#
#SBATCH --job-name=chinook_models
#SBATCH --output=chinook_models_%j.out
#SBATCH --error=chinook_models_%j.err
#SBATCH --account=rpp-gonzalez
#SBATCH --time=6:00:00         # Set a maximum runtime
...
# Run the R script
Rscript run_all_models_raw_Chinook.R